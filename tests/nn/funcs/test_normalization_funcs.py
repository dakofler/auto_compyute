...
#     assert close(w.grad, torch_w.grad)
#     assert close(b.grad, torch_b.grad)


# ac_x1, torch_x1 = get_random_floats((16, 32, 8))
...
# def test_batchnorm1d(x, w, b, m, training):
#     """Batchnorm1d function test"""
#     ac_x, torch_x = x
#     ac_w, torch_w = w
#     ac_b, torch_b = b
#     ac_rmean, torch_rmean = get_zeros((ac_x.shape[1],))
#     ac_rvar, torch_rvar = get_ones((ac_x.shape[1],))
#     ac_y = F.batchnorm1d(ac_x, ac_rmean, ac_rvar, ac_w, ac_b, m, 1e-5, training)
